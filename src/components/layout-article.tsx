  ...
  return (
    <>
      ...
      <main className="relative w-screen h-screen text-center dark:bg-gray-900 dark:text-gray-50">
        ...
        <div className="overflow-x-hidden text-xs tracking-tight text-gray-300 lowercase dark:text-gray-700 font-lyrics sm:text-sm lg:text-lg whitespace-nowrap">
          <p className="animate-scroll_lp">
        ...
        <div className="mx-16 my-10 text-left">
          {children} 
        </div> 
